...
labels = {
    # "Regular": "Baseline: Standard DQN (Q-Sum)", 
...
# 5. 保存并展示
plt.tight_layout()
plt.savefig("UAV_move_h150.png", dpi=300) # 保存为 300dpi 的高清图，可直接贴入大论文
print("画图成功！已保存为高清图片 UAV_move_h150.png")
plt.show()